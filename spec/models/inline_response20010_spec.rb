...
# Unit tests for RadioManagerClient::InlineResponse20010
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RadioManagerClient::InlineResponse20010 do
  let(:instance) { RadioManagerClient::InlineResponse20010.new }

  describe 'test an instance of InlineResponse20010' do
    it 'should create an instance of InlineResponse20010' do
      expect(instance).to be_instance_of(RadioManagerClient::InlineResponse20010)
    end
  end
