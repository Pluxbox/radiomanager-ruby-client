...
# Unit tests for RadioManagerClient::InlineResponse20011
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RadioManagerClient::InlineResponse20011 do
  let(:instance) { RadioManagerClient::InlineResponse20011.new }

  describe 'test an instance of InlineResponse20011' do
    it 'should create an instance of InlineResponse20011' do
      expect(instance).to be_instance_of(RadioManagerClient::InlineResponse20011)
    end
  end
