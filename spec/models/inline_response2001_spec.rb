...
# Unit tests for RadioManagerClient::InlineResponse2001
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RadioManagerClient::InlineResponse2001 do
  let(:instance) { RadioManagerClient::InlineResponse2001.new }

  describe 'test an instance of InlineResponse2001' do
    it 'should create an instance of InlineResponse2001' do
      expect(instance).to be_instance_of(RadioManagerClient::InlineResponse2001)
    end
  end
