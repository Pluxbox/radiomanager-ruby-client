...
# Unit tests for RadioManagerClient::InlineObject1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InlineObject1' do
  before do
    # run before each test
    @instance = RadioManagerClient::InlineObject1.new
  end
  ...
  describe 'test an instance of InlineObject1' do
    it 'should create an instance of InlineObject1' do
      expect(@instance).to be_instance_of(RadioManagerClient::InlineObject1)
    end
  end
