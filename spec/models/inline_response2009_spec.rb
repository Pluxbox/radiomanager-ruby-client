...
# Unit tests for RadioManagerClient::InlineResponse2009
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RadioManagerClient::InlineResponse2009 do
  let(:instance) { RadioManagerClient::InlineResponse2009.new }

  describe 'test an instance of InlineResponse2009' do
    it 'should create an instance of InlineResponse2009' do
      expect(instance).to be_instance_of(RadioManagerClient::InlineResponse2009)
    end
  end
