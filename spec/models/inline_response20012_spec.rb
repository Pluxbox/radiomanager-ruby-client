...
# Unit tests for RadioManagerClient::InlineResponse20012
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RadioManagerClient::InlineResponse20012 do
  let(:instance) { RadioManagerClient::InlineResponse20012.new }

  describe 'test an instance of InlineResponse20012' do
    it 'should create an instance of InlineResponse20012' do
      expect(instance).to be_instance_of(RadioManagerClient::InlineResponse20012)
    end
  end
