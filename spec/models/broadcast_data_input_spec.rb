...
# Unit tests for RadioManagerClient::BroadcastDataInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RadioManagerClient::BroadcastDataInput do
  let(:instance) { RadioManagerClient::BroadcastDataInput.new }

  describe 'test an instance of BroadcastDataInput' do
    it 'should create an instance of BroadcastDataInput' do
      expect(instance).to be_instance_of(RadioManagerClient::BroadcastDataInput)
    end
  end
