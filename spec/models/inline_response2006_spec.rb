...
# Unit tests for RadioManagerClient::InlineResponse2006
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RadioManagerClient::InlineResponse2006 do
  let(:instance) { RadioManagerClient::InlineResponse2006.new }

  describe 'test an instance of InlineResponse2006' do
    it 'should create an instance of InlineResponse2006' do
      expect(instance).to be_instance_of(RadioManagerClient::InlineResponse2006)
    end
  end
