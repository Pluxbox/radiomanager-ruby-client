...
# Unit tests for RadioManagerClient::InlineResponse20013
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RadioManagerClient::InlineResponse20013 do
  let(:instance) { RadioManagerClient::InlineResponse20013.new }

  describe 'test an instance of InlineResponse20013' do
    it 'should create an instance of InlineResponse20013' do
      expect(instance).to be_instance_of(RadioManagerClient::InlineResponse20013)
    end
  end
