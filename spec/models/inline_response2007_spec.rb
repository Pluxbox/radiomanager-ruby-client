...
# Unit tests for RadioManagerClient::InlineResponse2007
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RadioManagerClient::InlineResponse2007 do
  let(:instance) { RadioManagerClient::InlineResponse2007.new }

  describe 'test an instance of InlineResponse2007' do
    it 'should create an instance of InlineResponse2007' do
      expect(instance).to be_instance_of(RadioManagerClient::InlineResponse2007)
    end
  end
