...
# Unit tests for RadioManagerClient::Broadcast
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RadioManagerClient::Broadcast do
  let(:instance) { RadioManagerClient::Broadcast.new }

  describe 'test an instance of Broadcast' do
    it 'should create an instance of Broadcast' do
      expect(instance).to be_instance_of(RadioManagerClient::Broadcast)
    end
  end
