...
# Unit tests for RadioManagerClient::InlineObject
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InlineObject' do
  before do
    # run before each test
    @instance = RadioManagerClient::InlineObject.new
  end
  ...
  describe 'test an instance of InlineObject' do
    it 'should create an instance of InlineObject' do
      expect(@instance).to be_instance_of(RadioManagerClient::InlineObject)
    end
  end
