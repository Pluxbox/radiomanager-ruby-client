...
# Unit tests for RadioManagerClient::InlineResponse2004
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RadioManagerClient::InlineResponse2004 do
  let(:instance) { RadioManagerClient::InlineResponse2004.new }

  describe 'test an instance of InlineResponse2004' do
    it 'should create an instance of InlineResponse2004' do
      expect(instance).to be_instance_of(RadioManagerClient::InlineResponse2004)
    end
  end
