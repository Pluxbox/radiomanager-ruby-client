...
# Unit tests for RadioManagerClient::InlineResponse2005
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RadioManagerClient::InlineResponse2005 do
  let(:instance) { RadioManagerClient::InlineResponse2005.new }

  describe 'test an instance of InlineResponse2005' do
    it 'should create an instance of InlineResponse2005' do
      expect(instance).to be_instance_of(RadioManagerClient::InlineResponse2005)
    end
  end
