...
# Unit tests for RadioManagerClient::InlineResponse2008
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RadioManagerClient::InlineResponse2008 do
  let(:instance) { RadioManagerClient::InlineResponse2008.new }

  describe 'test an instance of InlineResponse2008' do
    it 'should create an instance of InlineResponse2008' do
      expect(instance).to be_instance_of(RadioManagerClient::InlineResponse2008)
    end
  end
