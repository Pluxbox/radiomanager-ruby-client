...
module RadioManagerClient
  class BroadcastApi
    ...
    # Create broadcast.
    # Create broadcast.
    # @param data [BroadcastDataInput] Data **(Required)**
    ...
    def get_broadcast_by_id_with_http_info(id, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'BroadcastResult' 
    ...
    def get_daily_epg_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'EPGResults' 
    ...
    # @option opts [String] :order_direction Direction of ordering *(Optional)*
    # @option opts [Integer] :_external_station_id Query on a different (content providing) station *(Optional)*
    # @return [Array<(BroadcastResults, Integer, Hash)>] BroadcastResults data, response status code and response headers
    def list_broadcasts_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'BroadcastResults' 
