...
module RadioManagerClient
  class ProgramApi
    ...
    # Create program.
    # Create program.
    # @param data [ProgramDataInput] Data **(Required)**
    ...
    def get_program_by_id_with_http_info(id, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'ProgramResult' 
    ...
    # @option opts [String] :order_direction Direction of ordering *(Optional)*
    # @option opts [Integer] :_external_station_id Query on a different (content providing) station *(Optional)*
    # @return [Array<(ProgramResults, Integer, Hash)>] ProgramResults data, response status code and response headers
    def list_programs_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'ProgramResults' 
