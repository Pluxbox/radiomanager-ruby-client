...
module RadioManagerClient
  class ProgramApi
    ...
    # Create program.
    # Create program.
    # @param program_data_input [ProgramDataInput] Data **(Required)**
    # @param [Hash] opts the optional parameters
    # @return [InlineResponse2002]
    def create_program(program_data_input, opts = {})
      data, _status_code, _headers = create_program_with_http_info(program_data_input, opts)
      data
    end
    ...
    def create_program_with_http_info(program_data_input, opts = {})
      ...
      if @api_client.config.client_side_validation && program_data_input.nil?
        fail ArgumentError, "Missing the required parameter 'program_data_input' when calling ProgramApi.create_program"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(program_data_input)
    ...
    # Delete program by id
    # @param id [Integer] ID of program **(Required)**
    # @param [Hash] opts the optional parameters
    ...
    def delete_program_by_id_with_http_info(id, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ProgramApi.delete_program_by_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Integer] :_external_station_id Query on a different (content providing) station *(Optional)*
    # @return [Array<(ProgramResult, Integer, Hash)>] ProgramResult data, response status code and response headers
    def get_program_by_id_with_http_info(id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ProgramResult'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['API-Key']

      new_options = opts.merge(
        :operation => :"ProgramApi.get_program_by_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def list_programs_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ProgramApi.list_programs",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # Update program by id
    # @param id [Integer] ID of Program **(Required)**
    # @param program_data_input [ProgramDataInput] Data *(Optional)*
    # @param [Hash] opts the optional parameters
    # @return [InlineResponse202]
    def update_program_by_id(id, program_data_input, opts = {})
      data, _status_code, _headers = update_program_by_id_with_http_info(id, program_data_input, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(InlineResponse202, Integer, Hash)>] InlineResponse202 data, response status code and response headers
    def update_program_by_id_with_http_info(id, program_data_input, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'program_data_input' is set
      if @api_client.config.client_side_validation && program_data_input.nil?
        fail ArgumentError, "Missing the required parameter 'program_data_input' when calling ProgramApi.update_program_by_id"
      end
      # resource path
      local_var_path = '/programs/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"ProgramApi.update_program_by_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
