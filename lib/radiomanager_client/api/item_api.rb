...
module RadioManagerClient
  class ItemApi
    ...
    def get_current_item_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'ItemResult' 
    ...
    # @option opts [String] :order_direction Direction of ordering *(Optional)*
    # @option opts [Integer] :_external_station_id Query on a different (content providing) station *(Optional)*
    # @return [Array<(ItemResults, Integer, Hash)>] ItemResults data, response status code and response headers
    def list_items_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'ItemResults' 
    ...
    # Post a playlist, do not remove previously imported items
    # @param [Hash] opts the optional parameters
    # @option opts [InlineObject2] :data 
    ...
    # Post a playlist, keep current structure
    # @param [Hash] opts the optional parameters
    # @option opts [InlineObject1] :data 
    # @return [InlineResponse202]
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [InlineObject3] :data 
    # @return [Success]
