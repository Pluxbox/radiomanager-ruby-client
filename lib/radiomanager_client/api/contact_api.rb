...
module RadioManagerClient
  class ContactApi
    ...
    # Create contact.
    # Create contact.
    # @param data [ContactDataInput] Data **(Required)**
    ...
    def get_contact_by_id_with_http_info(id, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'ContactResult' 
    ...
    # @option opts [String] :order_direction Direction of ordering *(Optional)*
    # @option opts [Integer] :_external_station_id Query on a different (content providing) station *(Optional)*
    # @return [Array<(ContactResults, Integer, Hash)>] ContactResults data, response status code and response headers
    def list_contacts_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'ContactResults' 
