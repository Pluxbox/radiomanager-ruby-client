...
module RadioManagerClient
  class GenreApi
    ...
    # Get genre by id
    # Get genre by id
    # @param id [Integer] ID of Genre **(Required)**
    ...
    def get_genre_by_id_with_http_info(id, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'GenreResult' 
    ...
    # @option opts [String] :order_direction Direction of ordering *(Optional)*
    # @option opts [Integer] :_external_station_id Query on a different (content providing) station *(Optional)*
    # @return [Array<(GenreResults, Integer, Hash)>] GenreResults data, response status code and response headers
    def list_genres_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'GenreResults' 
