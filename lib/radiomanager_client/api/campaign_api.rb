...
module RadioManagerClient
  class CampaignApi
    ...
    # Create campaign.
    # Create campaign.
    # @param campaign_data_input [CampaignDataInput] Data **(Required)**
    # @param [Hash] opts the optional parameters
    # @return [InlineResponse2002]
    def create_campaign(campaign_data_input, opts = {})
      data, _status_code, _headers = create_campaign_with_http_info(campaign_data_input, opts)
      data
    end
    ...
    def create_campaign_with_http_info(campaign_data_input, opts = {})
      ...
      if @api_client.config.client_side_validation && campaign_data_input.nil?
        fail ArgumentError, "Missing the required parameter 'campaign_data_input' when calling CampaignApi.create_campaign"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(campaign_data_input)
    ...
    def delete_campaign_by_id_with_http_info(id, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"CampaignApi.delete_campaign_by_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_campaign_by_id_with_http_info(id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CampaignResult'
    ...
    def list_campaigns_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"CampaignApi.list_campaigns",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # Update campaign by id
    # @param id [Integer] ID of Campaign **(Required)**
    # @param campaign_data_input [CampaignDataInput] Data **(Optional)**
    # @param [Hash] opts the optional parameters
    # @return [InlineResponse202]
    def update_campaign_by_id(id, campaign_data_input, opts = {})
      data, _status_code, _headers = update_campaign_by_id_with_http_info(id, campaign_data_input, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(InlineResponse202, Integer, Hash)>] InlineResponse202 data, response status code and response headers
    def update_campaign_by_id_with_http_info(id, campaign_data_input, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'campaign_data_input' is set
      if @api_client.config.client_side_validation && campaign_data_input.nil?
        fail ArgumentError, "Missing the required parameter 'campaign_data_input' when calling CampaignApi.update_campaign_by_id"
      end
      # resource path
      local_var_path = '/campaigns/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"CampaignApi.update_campaign_by_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
