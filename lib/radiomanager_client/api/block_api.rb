...
module RadioManagerClient
  class BlockApi
    ...
    # Get block by id
    # Get block by id
    # @param id [Integer] ID of Block **(Required)**
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Integer] :_external_station_id Query on a different (content providing) station *(Optional)*
    # @return [Array<(BlockResult, Integer, Hash)>] BlockResult data, response status code and response headers
    def get_block_by_id_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/blocks/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # return_type
      return_type = opts[:return_type] || 'BlockResult' 
    ...
    # @option opts [String] :order_direction Direction of ordering *(Optional)*
    # @option opts [Integer] :_external_station_id Query on a different (content providing) station *(Optional)*
    # @return [Array<(BlockResults, Integer, Hash)>] BlockResults data, response status code and response headers
    def list_blocks_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'BlockResults' 
