...
module RadioManagerClient
  class UserApi
    ...
    # @param id [Integer] ID of User **(Required)**
    ...
    def delete_user_by_id_with_http_info(id, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"UserApi.delete_user_by_id",
    ...
    def get_user_by_id_with_http_info(id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'UserResult'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['API-Key']

      new_options = opts.merge(
        :operation => :"UserApi.get_user_by_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # Invite user by mail
    # Invite user by mail
    # @param invite_user_data [InviteUserData] Data *(Required)*
    # @param [Hash] opts the optional parameters
    # @return [InlineResponse202]
    def invite_user_by_mail(invite_user_data, opts = {})
      data, _status_code, _headers = invite_user_by_mail_with_http_info(invite_user_data, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(InlineResponse202, Integer, Hash)>] InlineResponse202 data, response status code and response headers
    def invite_user_by_mail_with_http_info(invite_user_data, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && invite_user_data.nil?
        fail ArgumentError, "Missing the required parameter 'invite_user_data' when calling UserApi.invite_user_by_mail"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(invite_user_data)
      ...
      new_options = opts.merge(
        :operation => :"UserApi.invite_user_by_mail",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
