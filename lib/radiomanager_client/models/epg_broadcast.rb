  ...
  class EPGBroadcast
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'next_page_url')
        ...
        self.next_page_url = "http://radiomanager/pb/api/v1/broadcasts/epg/{identifier}/2016-01-12"
      end

      if attributes.has_key?(:'prev_page_url')
        self.prev_page_url = attributes[:'prev_page_url']
      else
        self.prev_page_url = "http://radiomanager/pb/api/v1/broadcasts/epg/{identifier}/2016-01-10"
      end
