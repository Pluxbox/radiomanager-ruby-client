...
module RadioManagerClient
  class ItemResult
    ...
    attr_accessor :data_modified

    attr_accessor :order

    attr_accessor :templateblock_id

    attr_accessor :templateitem_id
    ...
    def self.openapi_types
      {
        ...
        :'order' => :'Integer',
        :'templateblock_id' => :'Integer',
        :'templateitem_id' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RadioManagerClient::ItemResult` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RadioManagerClient::ItemResult`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'data_modified')
        self.data_modified = attributes[:'data_modified']
      end
      ...
      if attributes.key?(:'templateblock_id')
        self.templateblock_id = attributes[:'templateblock_id']
      end

      if attributes.key?(:'templateitem_id')
        self.templateitem_id = attributes[:'templateitem_id']
      end
      ...
      if attributes.key?(:'station_draft_id')
        self.station_draft_id = attributes[:'station_draft_id']
      end

      if attributes.key?(:'program_draft_id')
        self.program_draft_id = attributes[:'program_draft_id']
      end

      if attributes.key?(:'user_draft_id')
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          data_modified == o.data_modified &&
          order == o.order &&
          templateblock_id == o.templateblock_id &&
          templateitem_id == o.templateitem_id &&
    ...
    def hash
      [id, updated_at, created_at, deleted_at, data_modified, order, templateblock_id, templateitem_id, _external_station_id, model_type_id, block_id, external_id, field_values, title, duration, start, status, import, campaign_id, recommended, station_draft_id, program_draft_id, user_draft_id, static_start, details, block, broadcast, program, contacts, tags, campaign, model_type].hash
    end
