...
module RadioManagerClient
  class ProgramDataInput
    ...
    def hash
      [model_type_id, field_values, title, disabled, genre_id, description, short_name, medium_name, website, email, recommended, language, pty_code_id, tags, presenters].hash
    end
