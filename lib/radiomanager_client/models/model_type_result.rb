  ...
  class ModelTypeResult
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RadioManagerClient::ModelTypeResult` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RadioManagerClient::ModelTypeResult`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      model_validator = EnumAttributeValidator.new('String', ["broadcast", "program", "item", "campaign", "presenter", "contact", "external"])
    ...
    def model=(model)
      validator = EnumAttributeValidator.new('String', ["broadcast", "program", "item", "campaign", "presenter", "contact", "external"])
    ...
    def hash
      [id, name, model, created_at, updated_at, options, order, deleted_at, campaigns, broadcasts, programs, contacts, presenters, items, _external_station_id].hash
    end
