...
module RadioManagerClient
  class BroadcastResult
    ...
    def hash
      [id, updated_at, created_at, deleted_at, _external_station_id, program_id, model_type_id, station_id, field_values, title, start, stop, genre_id, description, short_name, medium_name, website, email, recommended, language, published, repetition_uid, repetition_type, repetition_end, repetition_start, repetition_days, pty_code_id, genre, items, blocks, program, tags, presenters, model_type].hash
    end
